...
File Path:   addons/wcd/lua/wcd/client/wcd_colors.lua
...
WCD.Colors.menuButton = {
	default = Vector(38, 38, 38),
	hover = Vector(204, 102, 0)
}

WCD.Colors.actionButton = {
	default = Vector(58, 58, 58),
	hover = Vector(204, 102, 0)
}

WCD.Colors.starButton = {
	default = Vector(38, 38, 38),
	hover = Vector(235, 219, 65)
}
